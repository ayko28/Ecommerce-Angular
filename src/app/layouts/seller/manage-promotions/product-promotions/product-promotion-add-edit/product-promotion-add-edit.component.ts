...
@Component({
  selector: 'app-product-promotion-add-edit',
  templateUrl: './product-promotion-add-edit.component.html',
  styleUrls: ['./product-promotion-add-edit.component.scss']
})
export class ProductPromotionAddEditComponent {
  ...
  ngOnInit() {
    ...
    this.myForm = this.formBuilder.group({
      ...
      buyX:['0',[Validators.min(1),Validators.max(10)]],
      getY :['0',[Validators.min(1),Validators.max(10)]],
...
//console.log('formattedStartDate:'+formattedStartDate)
      ...
      this.myForm.patchValue({
        ...
        buyX:this.product_Selected.buyX,
        getY:this.product_Selected.getY,
  ...
  get_Product(){
    ...
    this.servPromotion.get_Promotion_ProductById(this.param_PromoProd_id).subscribe((res:any)=>{
      this.product_Selected=res[0];
      console.log('mm in getpromotion of product res[0] is:'+ JSON.stringify(res[0]))
...
//  this.myForm.patchValue({startDate:this.format2Date(this.errorControl['startDate'].value)})
    this.servPromotion.editPromotion_Product(this.myForm.value).subscribe(response => {
           this.formSaved.emit(true);this.myForm.reset();
