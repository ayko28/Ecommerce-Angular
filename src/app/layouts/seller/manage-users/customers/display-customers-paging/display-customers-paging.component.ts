...
ngOnDestroy() {
 ...
 get_Users_role_Paging(){
  ...
  // pass here last parameter seller_id as this comp is of seller specific
  
  this.servUser.getUsers_Of_role_paging(this.page,this.limit,'Customer',this.authServ.currentUserValue!.id).subscribe((data: any) => {
