...
orderdetail:any[]=[];
product_list:any[]=[];
constructor(private servOrder:OrderService,private servOrderitem:OrderItemService,private servShared:SharedDataService,public servCommon:CommonService){}
ngOnInit(){
...
async ngOnChanges(changes: SimpleChanges) {
  ...
  setOrderStatusToShipping(){
    this.servOrder.serOrderStatus(this.Selected_Order_id_for_detail,'Shipping');
  }
  setOrderStatusToComplete(){
    this.servOrder.serOrderStatus(this.Selected_Order_id_for_detail,'Complete');
  }
